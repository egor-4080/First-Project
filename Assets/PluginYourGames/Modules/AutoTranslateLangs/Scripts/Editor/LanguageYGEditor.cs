    ...
    public class LanguageYGEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            scr.componentTextField =
                EditorGUILayout.ToggleLeft("Component Text/TextMeshPro Translate", scr.componentTextField);
               ...
               )
            {
                ...
                {
                    scr.uniqueFont =
                        (Font)EditorGUILayout.ObjectField("Unique Font", scr.uniqueFont, typeof(Font), false);
                    FontSettingsDraw();
                }
#if TMP_YG2
                else if (scr.textMPComponent)
                {
                    scr.uniqueFontTMP = (TMP_FontAsset)EditorGUILayout.ObjectField("Unique Font", scr.uniqueFontTMP,
            ...
            if (scr.additionalText != null)
                scr.additionalText = (LangYGAdditionalText)EditorGUILayout.ObjectField("Additional Text",
                    scr.additionalText, typeof(LangYGAdditionalText), false);
        ...
        void UpdateLanguages(bool CSVFile)
        {
            ...
            for (int i = 0; i < langArr.Length; i++)
            {
                if (langArr[i])
                {
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.Label(new GUIContent(UtilsLang.LangName(i), FullNameLanguages()[i]), GUILayout.Width(20),
                        GUILayout.Height(20));
