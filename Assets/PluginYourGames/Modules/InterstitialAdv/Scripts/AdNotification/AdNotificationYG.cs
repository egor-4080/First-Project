...
#else
        [Tooltip(
            "The maximum time for displaying the stub object before advertising. If the advertisement is not shown, the object will disappear after the time specified in this parameter.")]
#endif
        [Min(0.1f)]
