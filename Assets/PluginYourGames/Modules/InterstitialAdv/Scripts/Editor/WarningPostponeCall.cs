...
#if RU_YG2
                string labelText =
 "Для корректной работы скрипта необходимо включить опцию «Postpone Call By Fail» в настройках";
                string buttonText = "Включить опцию «Postpone Call By Fail»";
#else
                string labelText =
                    "For the script to work correctly, you need to enable the «Postpone Call By Fail» option in the settings";
