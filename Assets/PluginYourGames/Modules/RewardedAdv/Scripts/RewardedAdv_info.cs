...
#else
            [Tooltip(
                "Skip the next call of the regular advertisement after receiving the reward. This is required by some sites, because it may not be fair to show ads in one scene after the player has already watched the advertisement for a reward.")]
#endif
