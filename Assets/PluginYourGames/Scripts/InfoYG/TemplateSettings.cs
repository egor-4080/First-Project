...
namespace YG
{
    public partial class InfoYG
    {
        ...
        public partial class TemplatesSettings
        {
            ...
            {
                [Tooltip(Langs.t_gradient_radial)] public bool radial;

                [Tooltip(Langs.t_gradient_angle)] [NestedYG(0, "!radial"), Range(0, 360)]
            ...
            {
                [Tooltip(Langs.t_progressBar_round)] public bool round = true;
                ...
                [Range(1, 100)] public int height = 24;

                [Tooltip(Langs.t_progressBar_color1)] public Color color1 = new Color(0.25f, 0.6392f, 1f, 1f);

                [Tooltip(Langs.t_progressBar_color2)] public Color color2 = new Color(1f, 0.831f, 0.149f, 0.7f);
            }
#if RU_YG2
            ...
            [Tooltip(Langs.backgroundImgFormat)] public BackgroundImageFormat backgroundImgFormat;

            [NestedYG(8, 12, "!backgroundImgFormat"), Tooltip(Langs.t_gradient)]
            public Gradient gradientBackgroundByLoadGame;

            [Space(10)] public bool customProgressBar = true;

            [Tooltip(Langs.t_customProgressBar), NestedYG(8, 12, nameof(customProgressBar))]
            public ProgressBar progressBarSettigs;

            [Tooltip(Langs.t_fixedAspectRatio)] public bool fixedAspectRatio;
            [NestedYG(nameof(fixedAspectRatio))] public string aspectRatio = "16/9";

            [NestedYG(nameof(fixedAspectRatio))] public bool fillBackground;
