...
namespace YG
{
    public partial class InfoYG : ScriptableObject
    {
        ...
        public ProjectSettings platformOptions
        {
            get => Basic.platform.projectSettings;
        }
        ...
        public static void SetDefaultPlatform()
        {
            ...
            PlatformSettings standartPlatformSettings =
                AssetDatabase.LoadAssetAtPath<PlatformSettings>(standartPlatformSettingsPath);
        ...
        public static void CleanPlatforms(string ignorePlatform = null)
        {
            ...
            for (int i = 0; i < platfFolders.Length; i++)
            {
                ...
                IEnumerable<string> asmdefFiles =
                    files.Where(file => Path.GetExtension(file).Equals(".asmdef", StringComparison.OrdinalIgnoreCase));
                ...
                {
                    string content =
                        File.ReadAllText($"{PATCH_PC_YG2}/Scripts/Platform/Editor/AsmdefPlatformCreate.txt");
