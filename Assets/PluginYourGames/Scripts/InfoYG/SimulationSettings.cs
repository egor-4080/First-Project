...
namespace YG
{
    ...
    {
        [Tooltip(Langs.t_simulationInEditor)] public SimulationSettings Simulation = new SimulationSettings();
        ...
        public partial class SimulationSettings
        {
            ...
            [HeaderYG(Langs.advSimHeader, 5)] [Tooltip(Langs.t_advIntervalSimulation), Min(0)]
            public int advIntervalSimulation = 60;

            [Tooltip(Langs.t_advDurationAdv), Min(0)]
            public float durationAdv = 0.5f;

            [Tooltip(Langs.t_loadAdv), Min(0)] public float loadAdv = 0.0f;
