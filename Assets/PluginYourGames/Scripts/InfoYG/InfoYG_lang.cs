...
namespace YG.Insides
{
 ...
 "При радиальном градиенте первый цвет будет идти из центра плавно перетекать во второй цвет по краям. Radial = false - линейный градиент.";
        ...
        public const string t_progressBar_color2 =
 "Второстепенный  цвет полосы загрузки (по краям). Для получения однородного цвета всей полосы загрузки укажите один и тот же цвет для color 1 и color 2.";

        public const string t_pixelRatio =
 "Снижение качества изображения игры в угоду оптимизации для мобильных устройств.\nЧем выше число, тем выше качество. Диапазон от 1 до 2. Попробуйте поставить 1.3.";
        public const string t_developerBuild =
 "Тестовая сборка. Отображает номер билда в углу экрана (нажмите на текст чтобы скрыть). Помогает убедиться в том, что на сервере черновика актуальный билд. Служит напоминанием, что перед сборкой релизного билда необходимо установить соответствующие значения для параметра Code Optimization в Build Settings.";
        public const string t_fixedAspectRatio =
 "Фиксировать соотношение сторон? Например 16/9 - это горизонтальный экран. 9/16 - вертикальный. Для мобильных устройств изображение будет растягиваться на полный экран.";
        public const string t_simulationInEditor =
 "Настройки для симуляции в Unity Editor. Можете тестировать игру, например, на разных языках.";
        public const string advSimHeader = "Реклама";
        public const string advSimLabel = "Настройки симуляции в General Simulation";
        public const string t_advIntervalSimulation =
 "Симуляция интервала запросов на вызов рекламы в секундах для Unity Editor. Реальный таймер настройте в настройках модуля рекламы.";
        public const string t_advDurationAdv = "Длительность симуляции показа рекламы.";
        public const string t_loadAdv =
 "Задержка открытия рекламы. Может быть полезна для тестирования уведомления о том, что скоро откроется реклама, перед ёё показом (в момент ожидания рекламы).";
        ...
        public const string resetInfoSettings_dialog =
 "Сбросить все настройки плагина?\n(вернитесь назад с помощью ctrl + z)";
        ...
        public const string removeAllDemoDialog =
 "Все демонстрационные сцены и скрипты будут удалены. Восстановить их можно будет повторным импортом. Демо материалы содержатся в пакете самого плагина и в отдельных модулях.";
        ...
        public const string t_advIntervalSimulation =
            "Simulation of the interval of ad requests in seconds for Unity Editor. Set up the real timer in the settings of the advertising module.";

        public const string t_advDurationAdv = "The duration of the simulation of the ad display.";

        public const string t_loadAdv =
            "The delay in opening the ad. It can be useful for testing notifications that an ad is about to open before it is shown (while waiting for an ad).";
        ...
        public const string t_progressBar_color2 =
            "The secondary color of the loading bar (along the edges). To get a uniform color for the entire loading strip, specify the same color for color 1 and color 2.";
        ...
        public const string removeAllDemoDialog =
            "All demo scenes and scripts will be deleted. They can be restored by re-importing. Demo materials are contained in the package of the plugin itself and in separate modules.";
#endif
    }
}
#endif