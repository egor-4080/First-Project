...
namespace YG.EditorScr
{
    ...
    public static class DefineSymbols
    {
        ...
        public const string TMP_DEFINE = "TMP_YG2",
            TMP_PACKAGE = "com.unity.textmeshpro",
            TMP_NEW_PACKAGE = "com.unity.ugui";
        ...
        private static async void FirstStartup()
        {
            for (int i = 0; i <= 10; i++)
            {
                EditorUtility.DisplayProgressBar($"{InfoYG.NAME_PLUGIN} first startup", "first startup operations",
                    0.1f + (i / 20f));
        ...
        public static void UpdateDefineSymbols()
        {
            ...
            if (UnityPackagesManager.IsPackageImported(TMP_PACKAGE) ||
                UnityPackagesManager.IsPackageImported(TMP_NEW_PACKAGE))
        ...
        public static void PlatformDefineSymbols()
        {
            ...
            if (currentPlatform == "Error_yg" || currentPlatform == "ErrorPlatform_yg" || currentPlatform == "_yg" ||
            ...
            PlayerSettings.SetScriptingDefineSymbols(NamedBuildTarget.FromBuildTargetGroup(buildTargetGroup),
                definesText);
        }
