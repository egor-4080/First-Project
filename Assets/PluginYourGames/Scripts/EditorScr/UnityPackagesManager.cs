...
namespace YG.EditorScr
{
    public class UnityPackagesManager
    {
        ...
        {
            int option = EditorUtility.DisplayDialogComplex("Download package",
                $"To continue, you need to install the package: {packageName}\nInstall it?", "Yes", "No", "");
        ...
        {
            int option = EditorUtility.DisplayDialogComplex("Delete package",
                $"To continue, you need to delete the package: {packageName}\nDelete it?", "Yes", "No", "");
