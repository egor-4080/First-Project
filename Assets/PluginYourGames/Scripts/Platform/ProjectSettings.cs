...
namespace YG.Insides
{
    ...
    public partial class ProjectSettings
    {
        ...
        public void ApplySettings()
        {
            ...
            {
                bool currentAutoGraphicsAPIState =
                ...
                if (currentAutoGraphicsAPIState != autoGraphicsAPI)
                    PlayerSettings.SetUseDefaultGraphicsAPIs(EditorUserBuildSettings.activeBuildTarget,
                        autoGraphicsAPI);
            }
        ...
        private static void SafeSetManagedStrippingLevel()
        {
            ...
            var managedStrippingLevelEnum =
                typeof(PlayerSettings).Assembly.GetType("UnityEditor.ManagedStrippingLevel");
